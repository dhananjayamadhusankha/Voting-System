...
// echo "file...".$file."hh";
    ...
    //    $send_to_db = "INSERT INTO `users` ( `NAME`, `NIC`, `GENDER`, `MOBILE`, `EMAIL`, `PASSWORD`, `USER_TYPE`) VALUES ('{$name}', '{$nic}', '{$gender}', '{$phone}', '{$email}', '{$psw}', 'voter')";
       $send_to_db = "INSERT INTO `users` (`NAME`, `NIC`, `GENDER`, `MOBILE`, `EMAIL`, `PASSWORD`, `ADDRESS`, `IMG`, `USER_TYPE`) VALUES ('{$name}', '{$nic}', '{$gender}', '{$phone}', '{$email}', '{$hashed_pw}', '{$address}', '{$img}', 'artist')";
